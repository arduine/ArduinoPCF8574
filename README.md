...
```c++
void setup() {
    ArduinoPCF8574::getInstance()->setup(); // <-- 初始化
}

void onYouFunction() {
    // 读取状态
    auto gpio = ArduinoPCF8574::getInstance()->read(ArduinoPCF8574::J32);
    ...
    // 设置状态
    gpio.P5 = true;
    ArduinoPCF8574::getInstance()->write(ArduinoPCF8574::J32, gpio);
}
```
